...
$clients = $clientCrud->getAll();
   require_once 'config/Autan.php';
    ...
    $crud = new Client_crud();
  
    $recherche = isset($_GET['recherche']) ? trim($_GET['recherche']) : '';

    if(!empty($recherche)){
        $clients = $crud->search($recherche);
    } else {
        $clients = $crud->getAll();
    }
?>
...
<head>
    ...
    <link rel="stylesheet" href="dasbordclient.css">
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="menu">
            ...
            <a href="index.php?page=clients" class="menu-item">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="main-content">
        ...
        <div class="card-header">
            <a class="btn-add" href="clients/ajout_client.php">Ajouter une location</a>
            <div class="search-bar">
                <form method="GET" action="dasbordclient.php">
                    <input type="text" name="recherche" placeholder="Rechercher par client ou véhicule...">
                ...
                <?php if(!empty($clients)): ?>
                    <?php foreach($clients as $c): ?>
                        <tr>
                            ...
                            <td class="actions">
                                <a class="btn-edit" href="clients/modification_client.php?id=<?= $c['id'] ?>">Modifier</a>
                                <a class="btn-delete" href="clients/supprimer_client.php?id=<?= $c['id'] ?>"
