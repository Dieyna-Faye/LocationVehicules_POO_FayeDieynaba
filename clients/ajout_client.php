    ...
    <div class="form-container">
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="text" name="nom" placeholder="Ex: Dupont Jean" required>
            </div>

            <div class="form-group">
                <label>Email <span>*</span></label>
                <input type="email" name="email" placeholder="Ex: jean.dupont@email.com" required>
            </div>

            <div class="form-group">
                <label>Téléphone <span>*</span></label>
                <input type="text" name="telephone" placeholder="Ex: +33 6 12 34 56 78" required>
            </div>
