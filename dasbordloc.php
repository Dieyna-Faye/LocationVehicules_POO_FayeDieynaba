<?php
    ...
    $auth = new Autan();
    $auth->check();
    require_once 'Crud/Location_Crud.php';
...
<head>
    ...
    <link rel="stylesheet" href="dasbordloc.css">
            ...
            <div class="card">
                <div class="card1">
                    <div class="card-title">
                        <span>📋</span> Listes des Locations 
                    </div>

                    <div class="card-header">
                        <a class="btn-add" href="location/ajout_location.php">Ajouter une location</a>
                        <div class="search-bar">
                            <form method="GET" action="dasbordloc.php">
                    ...
                    <?php if(!empty($locations)): ?>
                        ...
                        <tr>
                            ...
                            <td data-label="Actions" class="actions">
                                <a class="btn-edit" href="location/modifier_location.php?id=<?= $l['id'] ?>">Modifier</a>
